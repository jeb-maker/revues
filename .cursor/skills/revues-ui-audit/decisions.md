...
| Formulaire `/modeles/new` (listUI) | **Tableau** desktop une ligne (Case · Aide · Obligatoire · actions) / **cartes** mobile ; Aide sans mention « optionnel » ; réordre desktop = **drag-and-drop** ; mobile = flèches tactiles ; CTA hors carte |
...
| Reste host | data-tables ; noscript `/signaler` (contrôles natifs) ; `hx-confirm` |
