...
| Formulaire `/modeles/new` (listUI) | **Compact** : 1 card, 1 case vide avec label visible « Case », Options → « Aide (optionnel) » ; H1 **Nouvelle liste** (pas « Nouvelle ») ; CTA « Créer la liste » ; domaines en `<details>` côté org |
