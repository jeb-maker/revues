...
| Formulaire `/modeles/new` (listUI) | **Tableau** desktop (`data-table`) / **cartes** mobile (`data-table--cards`) ; 1 case vide ; Aide en `<details>` ; H1 **Nouvelle liste** ; CTA séparé du « + Ajouter » (`.form-actions--list-submit` + filet) |
