...
| Formulaire `/modeles/new` (listUI) | **Tableau** desktop / **cartes** mobile ; Aide **toujours visible** ; réordre desktop = **drag-and-drop** (poignée) ; mobile = flèches tactiles larges ; CTA hors carte |
