...
func NewRouter(deps Deps) (http.Handler, *notifications.Service, error) {
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/subjects/{id}/members", subjectsHandler.AddMember)
		r.Post("/subjects/{id}/members/remove", subjectsHandler.RemoveMember)
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/admin/settings/policies", orgsHandler.LeadPoliciesShow)
		r.Post("/admin/settings/policies", orgsHandler.LeadPoliciesSave)
